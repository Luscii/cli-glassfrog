...
- [ ] **T002** [Shared] Add `PermissionError` + `RateLimited`, split 401/403→permission(4) and 429→rate-limit(5) in the shared classifier, refine once at the chokepoint, and surface the API's detail + next-step in the operator message — RED-first unit tests
