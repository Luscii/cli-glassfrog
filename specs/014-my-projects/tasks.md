...
- [ ] **T002** [Shared] Add the `my projects` command — `newMyProjectsCommand(seam)` + pure `runMyProjects`/`formatMyProjects` over an injected seam — RED-first unit tests for every branch
