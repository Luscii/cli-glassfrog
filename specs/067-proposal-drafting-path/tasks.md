...
- [x] **T001** [Shared] Author the proposal-drafting skill and the gated-write proposal-drafter agent, single-source the composed-leaf list, and register the agent — 15 BDD scenarios (skill + agent + commands.txt); auto-discovered from plugin/agents/, no plugin.json change
