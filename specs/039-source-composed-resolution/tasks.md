...
- [ ] **T001** [Shared] Define the package's core types
...
- [ ] **T002** [Shared] [P] Implement the `Resolve` walk
...
- [ ] **T003** [US1] [P] Implement the value-only source constructors
...
- [ ] **T004** [US2] [P] Implement the file source
...
- [ ] **T005** [US3] [P] Implement the stdin source
