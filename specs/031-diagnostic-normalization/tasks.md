...
- [x] **T002** [Shared] Apply the clarified behavior changes (decode→APIError, 401/403 split, 429 reset-window) — 5 scenarios un-@wip'd; decode→APIError ripple updated across 011–014 (5 unit tests, 4 BDD harnesses, 4 feature files); DEPRECATION.md entry recorded; cross-spec prose drift noted in LEARNINGS
