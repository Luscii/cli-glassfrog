...
- [ ] **T002** [Shared] Extend the `Outcome` enum + `ExitCode` registry with `NetworkUnavailable`(6)/`APIError`(3) and add the shared `classifyClientError` mapping 010's typed errors — RED-first unit tests
